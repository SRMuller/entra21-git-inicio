...
public class EmpresaService {
    ...
    public static List<EmpresaDTO> getAll() {
        return empresaRepository.findAll().stream().map((er) -> {
            ...
            dto.setEndereco(er.getEndereco());
            dto.setRazao_social(er.getRazao_social());
            dto.setFornecedor(er.getFornecedor());
            return dto;
    ...
    public void save(EmpresaDTO imput) {
        ...
        newEntity.setFornecedor(imput.getFornecedor());
    }
    ...
    public EmpresaEntity update(Long id, EmpresaEntity empresaEntity) {
        ...
        updateEmpresa.setFornecedor(empresaEntity.getFornecedor());
